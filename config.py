...
CODE_INTERPRETER_MAX_INPUT_FILE_BYTES = int(_get_env("CODE_INTERPRETER_MAX_INPUT_FILE_BYTES", "50000000"))
CODE_INTERPRETER_MAX_MOUNT_BYTES = int(_get_env("CODE_INTERPRETER_MAX_MOUNT_BYTES", "100000000"))
